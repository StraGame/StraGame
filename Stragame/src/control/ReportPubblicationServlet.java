	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(action==null) {
			...
			try {
				...
				RequestDispatcher dispatcher = getServletContext().getRequestDispatcher("/reportPubblication.jsp");
			...
			try {
				...
				if(bean.getTipo().equals("recensione")) {
					RequestDispatcher dispatcher = getServletContext().getRequestDispatcher("/ReviewDetailsServlet?id=" + codicepubblicazione);
					dispatcher.forward(request, response);
					...
					RequestDispatcher dispatcher = getServletContext().getRequestDispatcher("/TopicDetailsServlet?id=" + codicepubblicazione);
					dispatcher.forward(request, response);
