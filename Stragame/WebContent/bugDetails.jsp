            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                    ...
                    <ul class="nav navbar-nav navbar-right">
                        ...
                        <li><a href="prof.jsptml">Profile</a></li>
                    ...
                    <div class="post-details">
                            ...
                            <div class="row">
                                <div class="col-md-8">
                                    <div class="post-title-leftBug">
                                        <h3>Titolo Segnalazione Bug</h3> </div>
                                        <h4>Categoria</h4>
                                </div>
                                <div class="col-md-4">
                                    <p class='segnalazionecreata'>Segnalazione creata da: </p><span class="label utentes">&#128100 NomeUtente</span>
                                    <p class='videogiocoBug'>Videogioco: </p><span class="label videogiocob">&#127918 TitoloVideogioco</span>
                                </div>
                            </div>
                        </div>
                        <div class="post-details-info1982">
                            ...
                            <div class="post-footer29032">
                                <div class="clockcomment"> &#128336 Data segnalazione: 15/01/2021 10:58</div>
                            </div>
                        </div>
                    </div>
                </div>
