...
<body>
    ...
    <div class="container">
        <br>
        <h4><b>Presentazione</b></h4>
            <p>Stragame, è un forum per i videogiocatori, dove possono segnalare bug, scrivere recensioni e creare nuovi topic. Questo progetto è stato realizzato dal nostro Team.</p>
    </div>
    <section class="google-map390">
    <div class="container">
        <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2540.7235539939484!2d14.790342338422835!3d40.77419647627441!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x133bc5a5643af19d%3A0xc377a069f69748ad!2sDipartimento%20di%20Informatica%2C%20Universit%C3%A0%20di%20Salerno!5e0!3m2!1sit!2sit!4v1610455891750!5m2!1sit!2sit" width="100%" height="400" frameborder="0" style="border:0;" allowfullscreen="" aria-hidden="false" tabindex="0"></iframe>         
    </div>
    </section>
                    ...
                    <hr>
                        <form>
                            <div class="username-part940">
                                <span class="form-description38">Nickname* </span><input type="text" name="fname" class="username38" placeholder="Inserisci il tuo nickname">  
                            </div>
                            <div class="email-part320">
                                <span class="form-description39">E-Mail* </span><input type="text" name="fname" class="email39" placeholder="Inserisci la tua e-mail">  
                            </div>
                            <div class="question-title39">
                                <span class="form-description40">Motivatione* </span><input type="text" name="fname" class="question-ttile40" placeholder="Inserisci il titolo">
                            </div>
                            <div class="question-title39">
                                <span class="form-description43313">Dettagli* </span><textarea class="question-details3112" placeholder=""></textarea>
                            </div>
                        </form>
                        <div class="publish-button2389">
                            <button type="button" class="publis1291">Invia la tua richiesta</button>
                        </div>
                    </div>
                </div>
<!--                end of col-md-9 -->
...
<!--              login part-->
              <div class="login-part2389">
                  ...
                  <div class="rememberme">
								...
								<a href="signup.html" class="resbutton3892">Register</a>
							</div>
              </div>
