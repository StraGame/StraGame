        ...
        <div class="container">
            <div class="row">
                ...
                <div class="ask-question-input-part032">
                    <h4>Nuovo Topic</h4>
                    <hr>
                    <form action= "NewTopicServlet?action=insert" method = "post">
                        <div class="username-part940">
                            <span class="form-description43">Titolo* </span><input type="text" id="titolo" name="titolo" class="username029" placeholder="Inserisci il titolo">  
                        </div>
                        <div class="categori49">
                            <span class="form-description43305">Videogioco* </span>
                            <label>
                                <input list="browsers" name="videogioco" class="list-category53" placeholder="Scegli..."/>
                            </label>
                        ...
                        <div class="question-title39">
                            <span class="form-description43313">Descrizione* </span><textarea name="descrizione" id="descrizione" class="question-details3144" placeholder="Inserisci la descrizione"></textarea>
                        </div>
