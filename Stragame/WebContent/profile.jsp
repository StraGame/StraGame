                ...
                <div class="col-md-9">
                    <div class="about-user2039">
                        <div class="user-title3930">
                            ...
                            <hr> </div>
                        <div class="post-que-rep-rihght320"> <a href="reportPubblication.jsp" class="r-clor10">Report</a> </div>
                        ...
                        <div class="user-list10039">
                            <div class="ul-list-user-left">
                                <ul>
                                    ...
                                    <li><i>&#128271 <strong>Password:</strong></i><a href="changePassword.jsp" class="change-password">cambia password</a></li>
                                </ul>
                            </div>
                        </div>
