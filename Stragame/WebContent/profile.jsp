                ...
                <div class="col-md-9">
                    <div class="about-user2039">
                        <div class="user-title3930">
                            ...
                            <hr> </div>
                        <div class="post-que-rep-rihght320"> <a href="reportPubblication.html" class="r-clor10">Report</a> </div>
                        ...
                        <div class="user-list10039">
                            <div class="ul-list-user-left">
                                <ul>
                                    <li><i>&#9757 <strong>Nome:</strong> Ahmed</i></li>
                                    <li><i>&#9996 <strong>Cognome:</strong> Assan</i></li>
                                    <li><i>&#9997 <strong>Nickname:</strong> TorriGemelle02</i></li>
                                    <li><i>&#128231 <strong>E-mail:</strong> ahmedAssan@libero.it</i></li>
                                    <li><i>&#128271 <strong>Password:</strong></i><a href="changePassword.html" class="change-password">cambia password</a></li>
                                </ul>
                            </div>
                        </div>
                        <div class="user-description303">
                            <textarea class="description" placeholder="Duis dapibus aliquam mi, eget euismod sem scelerisque ut. Vivamus at elit quis urna adipiscing iaculis. Curabitur vitae velit in neque dictum blandit. Proin in iaculis neque. Pellentesque habitant morbi tristique senectus et netus et malesuada fames ac turpis egestas. Curabitur vitae velit in neque dictum blandit."></textarea> 
                            <a href="#" class="change-description">Modifica descrizione</a> </div>
                    </div>
                ...
                <aside class="col-md-3 sidebar97239">
                    ...
                    <div class="login-part2389">
                        ...
                        <div class="rememberme">
                            <label>
                                <input type="checkbox" checked="checked"> Ricordami</label> <a href="signup.html" class="resbutton3892">Registrati</a> </div>
                    </div>
                    <!--              highest part-->
