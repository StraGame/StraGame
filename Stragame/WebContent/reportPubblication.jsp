...
<body>
    ...
    <section class="main-content920">
        <div class="container">
            <div class="row">
                <div class="col-md-9">
                    <h3><p class="titolo1"><b> Pubblicazione: Titolo</b></p></h3>
                    <p class="genere">Tipo: tipo</p>
                    <div id="main">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="replay-input-name42389">
                                        <p>Categoria*</p>
                                        <label>
                                            <input list="browsers" name="myBrowser" class="list-category543" placeholder="Scegli..."/>
                                        </label>
