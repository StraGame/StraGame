                            ...
                            <form id="form" action="ReportPubblicationServlet?action=insert&id=<%=bean.getCodicePubblicazione() %>" method="post">
                                <div class="col-md-4">
                                    <div class="replay-input-name42389">
                                        <p>Categoria*</p>
                                        <label>
                                            <input list="browsers" name="categoria" class="list-category543" placeholder="Scegli..."/>
                                        </label>
                                        <datalist id="browsers">
                                            <option value="Linguaggio inappropriato">
                                            <option value="Allegato inappropriato">
                                            <option value="Spam">
                                        </datalist>
                                    </div>
                                </div>
                                <div class="post9320-box">
                                    <textarea class="comment-input219882" placeholder="Scrivi il tuo commento" name="testo"></textarea></div>
