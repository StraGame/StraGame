                ...
                <div class="ask-question-input-part032">
                    ...
                    <form id="form" action="NewReviewServlet?action=insert" enctype="multipart/form-data" method="post" name="newTopicForm" onsubmit="return validate(<%=(String) request.getSession().getAttribute("username")%>)">
                        <div class="username-part940">
                            <span class="form-description43">Titolo* </span><input type="text" name="titolo" class="username029" placeholder="Scegli il titolo" required>  
                        </div>
                        ...
                        <div class="question-title39">
                            <span class="form-description43313">Descrizione* </span><textarea class="question-details3133" name="descrizione" placeholder="" required></textarea>
                        </div>
