        ...
        <div class="container">
            <div class="row">
                ...
                <div class="ask-question-input-part032">
                    ...
                    <hr>
                    <form id="form" action="NewReviewServlet?action=insert" method="post">
                        <div class="username-part940">
                            <span class="form-description43">Titolo* </span><input type="text" name="titolo" class="username029" placeholder="Scegli il titolo">  
                        </div>
                        ...
                        <div class="question-title39">
                            <span class="form-description43313">Descrizione* </span><textarea class="question-details3133" name="descrizione" placeholder=""></textarea>
                        </div>
