                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-2">
                                        <div class="ques-type302">
                                            <br><br><br>
                                            <a href="bugDetails.html" ><button class="button viewSegnalazione">Vedi segnalazione</button></a>
                                            <br><br>
                           ...
                           <div class="question-type2033">
                                <div class="row">
                                    ...
                                    <div class="col-md-2">
                                        <div class="ques-type302">
                                            <br><br><br>
                                            <a href="report.html" ><button class="button viewSegnalazione">Vedi segnalazione</button></a>
                                            <br><br>
                                            <button class="button deleteuser">Elimina Bug Segnalato</button>
                                        </div>
                                    </div>
