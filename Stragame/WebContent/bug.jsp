<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
   ...
   <% ArrayList<BugBean> bugList = (ArrayList<BugBean>) request.getAttribute("bugList"); %>
...
<%@ page contentType="text/html; charset=ISO-8859-1" import="java.util.*, java.util.ArrayList, model.BugBean"%>

<% if(videogiochi==null){
	
	response.sendRedirect("./BugServlet");	
	return;
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                    ...
                    <ul class="nav navbar-nav navbar-right">
                        ...
                        <li class="dropdown"> <a href="#" c.jsp"dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="true">Topic <span class="caret"></span></a>
                        ...
                        <li class="dropdown"> <a href="#" c.jsp"dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="true">News <span class="caret"></span></a>
                            <ul class="dropdown-menu animated zoomIn">
            ...
            <div class="row">
                <div class="col-md-9">
                    <div id="main">
                        ...
                        <label for="tab1">Segnalazione bug</label>
                        ...
                        <label for="tab3">Categoria
                            <input list="browsers" name="myBrowser" class="list-category534"/>
                        </label>
                                    	...
                                    	<div class="col-md-9">
                                        	<div class="right-description893">
                                            	<div id="que-hedder2983">
                                                	...
                                                	<span class="label categoria"><%=b.getCategoria() %></span>
                                                	<h3><a href="bugDetails.jsp" target="_self"><%=b.getTitolo() %></a></h3> </div>
                                            	<div class="ques-details10018">
                                                	<p><%=b.getTesto() %></p>
                                            	</div>
                                            	<hr>
                                            	<div class="clockcomment"> &#128336 Inserito il: <%=b.getData() %></div>
                                        	</div>
                                    	</div>
                                    	<div class="col-md-2">
                                        	<div class="ques-type302">
                                            	<br><br><br>
                                            	<a href="bugDetails.jsp" ><button class="button viewSegnalazione">Vedi segnalazione</button></a>
                                            	<br><br>
                                            	<button class="button deleteuser">Elimina Bug Segnalato</button>
                                        	</div>
                                    	</div>
                                	</div>
                            	</div>
                        ...
                        <section id="content2">
                        <!-- questa è per filtrarli per i videogiochi  -->
                        <%ArrayList<BugBean> bugListV = (ArrayList<BugBean>) request.getAttribute("bugListV");%>
                        <%if(bugListV!=null){ %>
                           
	                        
	                        	<%for(BugBean b: bugListV){ %>
