            ...
            <div class="row">
                <div class="col-md-9">
                    <div id="main">
                        ...
                        <form class="form-inline" action="BugServlet" method="post">
                        ...
                        <input list="categorie" name="categoria" class="list-category534"/>
                        <datalist id="categorie">
                            <option value="Bug Grafico">
                            <option value="Bug Audio">
                            <option value="Comandi Mancanti">
