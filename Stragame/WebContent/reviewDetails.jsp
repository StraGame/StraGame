                    ...
                    <div class="post-details">
                        <div class="details-header923">
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="post-que-rep-rihght320"> <a href="#comment289-box"><i class="fa fa-question-circle" aria-hidden="true"></i> Commenta</a> <a href="reportPubblication.html" class="r-clor10">Report</a> </div>
                                </div>
                            </div>
                        </div>
