                ...
                <div class="ask-question-input-part032">
                    ...
                    <form>
                        <div class="username-part940">
                            <span class="form-description43">Titolo* </span><input type="text" name="fname" class="username029" placeholder="Inserisci il titolo">  
                        </div>
                        <div class="categori49">
                            <span class="form-description43305">Videogioco* </span>
                            <label>
                                <input list="browsers" name="myBrowser" class="list-category53" placeholder="Scegli il videogioco"/>
                            </label>
                        ...
                        <div class="categori49">
                            ...
                            <label>
                                <input list="browsers" name="myBrowser" class="list-category53" placeholder="Scegli la categoria"/>
                            </label>
                            <datalist id="browsers">
                                <option value="Front_End Web Developer">
                                <option value="Back-End develoer">
                        ...
                        <div class="question-title39">
                            <span class="form-description43313">Descrizione* </span><textarea class="question-details3122" placeholder="Inserisci la descrizione"></textarea>
                        </div>
