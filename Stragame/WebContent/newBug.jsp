...
<%@ page contentType="text/html; charset=ISO-8859-1" import="java.util.*, java.util.ArrayList"%>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="ask-question-input-part032">
                    <h4>Segnala Bug</h4>
                    <hr>
                    <form id="form" action="NewBugServlet?action=insert" method="post">
                        ...
                        <div class="categori49">
                            ...
                            <label>
                                <input list="browsers" name="videogioco" class="list-category53" placeholder="Scegli il videogioco"/>
                            </label>
                        ...
                        <div class="categori49">
                            ...
                            <label>
                                <input list="categorybrowser" name="categoria" class="list-category53" placeholder="Scegli la categoria"/>
                            </label>
                        ...
                        <div class="question-title39">
                            <span class="form-description43313">Descrizione* </span><textarea class="question-details3122" name ="descrizione" placeholder="Inserisci la descrizione"></textarea>
                        </div>
