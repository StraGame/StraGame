                ...
                <div class="ask-question-input-part032">
                    ...
                    <form id="form" action="NewBugServlet?action=insert" method="post" name="newBugForm" onsubmit="return validate(<%=(String) request.getSession().getAttribute("username")%>)">
                        <div class="username-part940">
                            <span class="form-description43">Titolo* </span><input type="text" name="titolo" class="username029" placeholder="Inserisci il titolo" required>  
                        </div>
                        <div class="categori49">
                            <span class="form-description43305">Videogioco* </span>
                            <label>
                                <input list="browsers" name="videogioco" class="list-category53" placeholder="Scegli il videogioco" required/>
                            </label>
                        ...
                        <div class="categori49">
                            <span class="form-description43306">Categoria* </span>
                            <label>
                                <input list="categorybrowser" name="categoria" class="list-category53" placeholder="Scegli la categoria" required/>
                            </label>
                        ...
                        <div class="question-title39">
                            <span class="form-description43313">Descrizione* </span><textarea class="question-details3122" name ="descrizione" placeholder="Inserisci la descrizione" required></textarea>
                        </div>
