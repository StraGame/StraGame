                ...
                <div class="ask-question-input-part032">
                    ...
                    <form id='form' action="VideoGameServlet?action=insert" enctype="multipart/form-data" method="POST" name="newGameForm" onsubmit="return validate(<%=(String) request.getSession().getAttribute("username")%>)">
                        ...
                        <div class="categori49">
                            ...
                            <label>
                                <input list="browsers" name="genere" class="list-category53" placeholder="Scegli..." required/>
                            </label>
                            <datalist id="browsers">
                                ...
                                <option value="Free-to-play">
                                <option value="MMORPG">
                                <option value="MOBA">
                                <option value="Picchiaduro">
                                <option value="Simulazione">
                                <option value="Sparatutto">
                            </datalist>
                        </div>
                        <div class="question-title39">
                            <span class="form-description43313">Descrizione* </span><textarea class="question-details3144" placeholder="Inserisci la descrizione" name="descrizione" required></textarea>
                        </div>
