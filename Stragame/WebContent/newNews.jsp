                    ...
                    <ul class="nav navbar-nav navbar-right">
                        ...
                        <li class="dropdown"> <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="true">Topic <span class="caret"></span></a>
                            <ul class="dropdown-menu animated zoomIn">
                                ...
                                <li><a href="newTopic.jsp" target="_self">Inserisci nuova News</a></li>
                            </ul>
                        </li>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="ask-question-input-part032">
                    <h4>Nuova News</h4>
                    <hr>
                    <form id="form" action="NewNewsServlet?action=insert" method="POST">
                        ...
                        <div class="question-title39">
                            <span class="form-description43313">Descrizione* </span><textarea class="question-details3144" name="descrizione" placeholder="Inserisci la descrizione"></textarea>
                        </div>
