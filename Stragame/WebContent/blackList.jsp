                                ...
                                <div class="col-md-9">
                                    <div class="right-description893">
                                        <div id="que-hedder2983">
                                            <h3><a href="profile.jsp" target="_self">Utente</a></h3> 
                                        </div>
                                        <hr>
                                    ...
                                    <div class="col-md-2">
                                        <div class="ques-type302">
                                            <br>
                                            <a href="reportDetails.jsp" ><button class="button viewSegnalazione">Vedi segnalazione</button></a>
                                            <br><br>
                                ...
                                <div class="question-type2033">
                                    <div class="row">
                                        ...
                                        <div class="col-md-9">
                                            <div class="right-description893">
                                                <div id="que-hedder2983">
                                                    <h3><a href="profile.jsp" target="_self">NomeUtente</a></h3> 
                                                </div>
                                                <hr>
                                                    <div class="clockcomment"> &#128336 Segnalata il: 15/01/2021 10:58
                                                    </div>
