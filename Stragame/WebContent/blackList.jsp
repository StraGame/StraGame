                                ...
                                <div class="col-md-9">
                                    <div class="right-description893">
                                        <div id="que-hedder2983">
                                            <h3><a href="post-deatils.html" target="_self">Utente</a></h3> 
                                        </div>
                                        <hr>
                                    ...
                                    <div class="col-md-2">
                                        <div class="ques-type302">
                                            ...
                                            <br><br>
                                            <button class="button deleteuser">Elimina Utente</button>
                                        </div>
                                    </div>
                                </div>
                            </div> 
                                ...
                                <div class="question-type2033">
                                    <div class="row">
                                        ...
                                        <div class="col-md-9">
                                            <div class="right-description893">
                                                <div id="que-hedder2983">
                                                    <h3><a href="post-deatils.html" target="_self">NomeUtente</a></h3> 
                                                </div>
                                                <hr>
                                                    <div class="clockcomment"> &#128336 Segnalata il: 15/01/2021 10:58
                                                    </div>
