...
<%@ page contentType="text/html; charset=ISO-8859-1" import="java.util.*, java.util.ArrayList, model.UserBean,model.NewsBean"%>

<%if(news==null || users==null){
                        ...
                        <div class="question-type2033">
                            <div class="row">
                                <div class="col-md-1">
                                    ...
                                    <br>
                                        <img src="GetPhoto?username=<%=user.getNickname()%>&action=user" onerror="this.src='image/images.png'" alt="image">
                                    </div>
                                </div>
                                <div class="col-md-9">
                                    ...
                                    <div class="col-md-2">
                                        <div class="ques-type302">
                                            <br>
                                            <a href="listReportPubblication.jsp" ><button class="button viewSegnalazione">Vedi Segnalazioni</button></a>
                                            <br><br>
                                            <a href="BlackListServlet?action=deleteUser&nickname=<%=user.getNickname() %>" ><button class="button deleteuser">Elimina Utente</button></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
