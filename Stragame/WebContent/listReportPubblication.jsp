                                ...
                                <div class="col-md-9">
                                    <div class="right-description893">
                                        <div id="que-hedder2983">
                                            ...
                                            <span class="label videogioco">Recensione</span>
                                            <h3><a href="reviewDetails.jsp" target="_self">Titolo</a></h3> 
                                        </div>
                                        <hr>
                                            <div class="clockcomment"> &#128336 Segnalata il: 15/01/2021 10:58
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-2">
                                        <div class="ques-type302">
                                            <a href="reportDetails.jsp" ><button class="button viewSegnalazionep">Vedi segnalazione</button></a>
                                            <button class="button approve">Approva Pubblicazione</button>
                                            <button class="button delete">Elimina Pubblicazione</button>
                                        </div>
                                    </div>
                                </div>
                            </div> 
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-9">
                                        <div class="right-description893">
                                            <div id="que-hedder2983">
                                                <span class="label utente">&#128100 NomeUtente</span>
                                                <span class="label videogioco">Topic</span>
                                                <h3><a href="topicDetails.jsp" target="_self">Titolo</a></h3> 
                                            </div>
                                            <hr>
                                                <div class="clockcomment"> &#128336 Segnalata il: 15/01/2021 10:58
                                                </div>
