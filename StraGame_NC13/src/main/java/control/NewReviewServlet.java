  ...
  public void doPost(HttpServletRequest request, HttpServletResponse response) 
    ...
    if (action == null) {
      ...
      if (videogioco.length() == 0) {
        ...
        if (gameplay == 0) {
          throw new IllegalArgumentException("Il gameplay � minore di 1 o maggiore di 10");
        } else if (gameplay < 0) {
          throw new IllegalArgumentException("Il gameplay � minore di 1 o maggiore di 10");
        } else if (gameplay > 10) {
          throw new IllegalArgumentException("Il gameplay � minore di 1 o maggiore di 10");
        ...
        if (grafica == 0) {
          throw new IllegalArgumentException("La grafica � minore di 1 o maggiore di 10");
        } else if (grafica < 0) {
          throw new IllegalArgumentException("La grafica � minore di 1 o maggiore di 10");
        } else if (grafica > 10) {
          throw new IllegalArgumentException("La grafica � minore di 1 o maggiore di 10");
        ...
        if (trama == 0) {
          throw new IllegalArgumentException("La trama � minore di 1 o maggiore di 10");
        } else if (trama < 0) {
          throw new IllegalArgumentException("La trama � minore di 1 o maggiore di 10");
        } else if (trama > 10) {
          throw new IllegalArgumentException("La trama � minore di 1 o maggiore di 10");
        ...
        if (votocomplessivo == 0) {
          throw new IllegalArgumentException("Il voto complessivo � minore di 1 o maggiore di 10");
