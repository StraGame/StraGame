...
<% if(videogiochi==null || topicListV==null || news==null){
                                ...
                                <div class="row">
                                    <div class="col-md-1">
                                        <div class="left-user12923 left-user12923-repeat">
                                            <img src="GetPhoto?username=<%=p.getAutore()%>&action=user" alt="image" onerror="this.src='image/images.png'">
                                        </div>
                                    </div>
                                    <div class="col-md-9">
                                        <div class="right-description893">
                                            <div id="que-hedder2983">
                                                ...
                                                <h3><a href="TopicDetailsServlet?id=<%=p.getCodicePubblicazione() %>" ><%=p.getTitolo() %></a></h3> </div>
                                    ...
                                    <div class="col-md-2">
                                        <div class="ques-type302">
                                                ...
                                                <%if(c.getCodicePubblicazione()==p.getCodicePubblicazione()){%>
                                                <%cont=cont+1; %>
                                                <%} %>
                                                <%} %>
