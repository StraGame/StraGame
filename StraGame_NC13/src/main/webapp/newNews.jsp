...
<%if(news==null){
	response.sendRedirect("./NewNewsServlet");	
	return;
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="ask-question-input-part032">
                    ...
                    <form id="form" action="NewNewsServlet?action=insert" enctype="multipart/form-data" method="POST" name="newNewsForm" onsubmit="return validate(<%=(String) request.getSession().getAttribute("username")%>)">
                        <div class="username-part940">
                            <span class="form-description43">Titolo* </span><input type="text" name="titolo" class="username029" pattern="([a-zA-Z0-9 ]{5,45})" title="La lunghezza deve essere compresa fra 5 e 45" placeholder="Inserisci il titolo" required>  
                        </div>
                        <div class="question-title39">
                            <span class="form-description43313">Descrizione* </span><textarea class="question-details3144" name="descrizione" placeholder="Inserisci la descrizione" maxlength="750" required></textarea>
                        </div>
