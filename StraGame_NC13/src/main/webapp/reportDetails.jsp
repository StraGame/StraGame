<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
   ...
   <%ReportPubblicationBean report= (ReportPubblicationBean) request.getAttribute("report"); %>
	                            ...
	                            <div class="row">
	                                <div class="col-md-8">
	                                    <div class="post-title-left129">
	                                        ...
	                                        <h4><%=report.getCategoria() %></h4>
	                                </div>
	                                <div class="col-md-4">
	                                    <p class='segnalazionecreata'>Segnalazione creata da: </p><span class="label utentes">&#128100 <%=report.getAutore() %></span>
	                                </div>
	                            </div>
	                        </div>
	                        <div class="post-details-info1982">
	                            <p><%=report.getDescrizione() %></p>
	                            <hr>
	                            <div class="post-footer29032">
	                                <div class="clockcomment"> &#128336 Data segnalazione: <%=report.getData() %></div>
	                            </div>
	                        </div>
	                    </div>
	                </div>
