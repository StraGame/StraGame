...
<% if(videogiochi==null || news==null){
	...
	response.sendRedirect("./NewBugServlet");	
	return;
...
<section class="header-descriptin329">
  ...
  <li><a href="#">Home</a></li>
  <li class="active">Segnalazione Bug</li>
</ol>
    </div>
</section>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="ask-question-input-part032">
                    ...
                    <form id="form" action="NewBugServlet?action=insert" method="post" name="newBugForm" onsubmit="return validate(<%=(String) request.getSession().getAttribute("username")%>)">
                        <div class="username-part940">
                          <span class="form-description43">Titolo* </span><input type="text" pattern="[a-zA-Z0-9 ]{5,45}" title="la lunghezza del titolo deve essere compresa fra 5 e 45 caratteri" id="titolo" name="titolo" class="username029" placeholder="Inserisci il titolo" required>  
                        </div>
                        ...
                        <div class="categori49">
                            <span class="form-description43305">Categoria* </span>
                            <select name="categoria" id="categoria" class="list-category53" style="width:200px;"> 
                                
                                <option value="Bug audio">Bug audio</option> 
                                <option value="Bug grafico">Bug grafico</option>
                                <option value="Comandi mancanti">Comandi mancanti</option>
                                <option value="Altro">Altro</option>
                                
                            </select>
                        </div>
                        <div class="question-title39">
                            <span class="form-description43313">Descrizione* </span><textarea name="descrizione" maxlength="300" id="descrizione"  class="question-details3144" placeholder="Inserisci la descrizione" required></textarea>
                        </div>
