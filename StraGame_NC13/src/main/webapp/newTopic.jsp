...
<% if(videogiochi==null || news==null){
	...
	response.sendRedirect("./NewTopicServlet");	
	return;
...
<section class="header-descriptin329">
                       <div class="container">
                       <h3>Inserisci nuovo topic</h3>
                        <ol class="breadcrumb breadcrumb839">
  <li><a href="index.jsp">Home</a></li>
  <li class="active">Nuovo topic</li>
</ol>
    </div>
</section>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="ask-question-input-part032">
                    ...
                    <form action= "NewTopicServlet?action=insert" enctype="multipart/form-data" method = "post" name="newTopicForm" onsubmit="return validate(<%=(String) request.getSession().getAttribute("username")%>)">
                        <div class="username-part940">
                            <span class="form-description43">Titolo* </span><input type="text" pattern="([a-zA-Z0-9 ]{5,45})" title="la lunghezza del titolo deve essere compresa fra 5 e 45 caratteri,usare solo lettere maiuscole,minuscole e numeri" id="titolo" name="titolo" class="username029" placeholder="Inserisci il titolo" required>  
                        </div>
                        ...
                        <div class="question-title39">
                            <span class="form-description43313">Descrizione* </span><textarea name="descrizione" maxlength="2000" id="descrizione" class="question-details3144" placeholder="Inserisci la descrizione" required></textarea>
                        </div>
