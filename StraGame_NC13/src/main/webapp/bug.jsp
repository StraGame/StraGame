            ...
            <div class="row">
                <div class="col-md-9">
                    <div id="main">
                        ...
                        <select id="categorie" name="categoria" class="list-category534">
                        	<option value=""></option>
                                	...
                                	<div class="row">
                                    	...
                                    	<div class="col-md-9">
                                        	<div class="right-description893">
                                            	<div id="que-hedder2983">
                                                	...
                                                	<h3><a href="BugDetailsServlet?id=<%=b.getCodicebug() %>" target="_self"><%=b.getTitolo() %></a></h3> </div>
                                    	...
                                    	<div class="col-md-2">
                                        	<div class="ques-type302">
                                            	<br><br><br>
                                            	<a href="BugDetailsServlet?id=<%=b.getCodicebug() %>" ><button class="button viewSegnalazione">Vedi segnalazione</button></a>
                                            	<br><br>
                                            	<a href="BugServlet?action=deleteBug&id=<%=b.getCodicebug() %>" ><button class="button deleteuser">Elimina Bug Segnalato</button></a>
                                        	</div>
                                    	</div>
                                	</div>
                            	</div>
