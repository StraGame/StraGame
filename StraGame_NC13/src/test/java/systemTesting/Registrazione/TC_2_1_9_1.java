...
class TC_2_1_9_1 {
  ...
  @Test
  public void testTC2191() throws Exception {
    ...
    driver.findElement(By.id("email")).sendKeys("mariorossi@yahoo.it");
    driver.findElement(By.id("password")).clear();
    driver.findElement(By.id("password")).sendKeys("Ciao1234");
    driver.findElement(By.id("confirm_password")).clear();
    driver.findElement(By.id("confirm_password")).sendKeys("Ciao12345");
