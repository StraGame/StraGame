...
class TestReportPubblicationServlet {
  ...
  @Test
    ...
    request.addParameter("id", "3240");
    request.getSession().setAttribute("username", "adm12345");
    request.addParameter("testo", "devo scrivere pi� di 300 caratteri, "
        + "non so che scrivere quindi ricopio. devo scrivere pi� di 300 caratteri, "
        + "non so che scrivere quindi ricopio. devo scrivere pi� di 300 caratteri, "
        + "non so che scrivere quindi ricopio. devo scrivere pi� di 300 caratteri, "
        + "non so che scrivere quindi ricopio. devo scrivere pi� di 300 caratteri, "
        + "non so che scrivere quindi ricopio.");
  ...
  @Test
    ...
    request.addParameter("testo", "Testo della segnalazione");
    request.addParameter("categoria", 
        "Questa categoria deve essere lunga pi� di quarantacinque caratteri");
