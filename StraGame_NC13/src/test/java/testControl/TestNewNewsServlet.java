...
class TestNewNewsServlet {
  ...
  public void TC_3_1_3_1() {
    ...
    request.addParameter("titolo", "Nuova news");
    request.getSession().setAttribute("username", "adm12345");
    request.addParameter("descrizione", "La descrizione non rispetta la lunghezzaLa "
        + "descrizione non rispetta la lunghezzaLa descrizione non rispetta la "
        + "lunghezzaLa descrizione non rispetta la lunghezzaLa descrizione non "
        + "rispetta la lunghezzaLa descrizione non rispetta la lunghezza la "
        + "descrizione non rispetta la lunghezzaLa descrizione non rispetta "
        + "la lunghezzaLa descrizione non rispetta la lunghezzaLa descrizione "
        + "non rispetta la lunghezzaLa descrizione non rispetta la lunghezzaLa "
        + "descrizione non rispetta la lunghezzaLa descrizione non rispetta la "
        + "lunghezzaLa descrizione non rispetta la lunghezzaLa descrizione non "
        + "rispetta la lunghezzaLa descrizione non rispetta la lunghezzaLa "
        + "descrizione non rispetta la lunghezzaLa descrizione non rispetta la "
        + "lunghezzaLa descrizione non rispetta la lunghezzaLa descrizione non "
        + "rispetta la lunghezzaLa descrizione non rispetta la lunghezzaLa "
        + "descrizione non rispetta la lunghezzaLa descrizione non rispetta "
        + "la lunghezzaLa descrizione non rispetta la lunghezzaLa descrizione"
        + " non rispetta la lunghezzaLa descrizione non rispetta la lunghezza "
        + "la descrizione non rispetta la lunghezzaLa descrizione non "
