...
class TestPubblicationDto {
	...
	void testInsertTopicSuccess() {
		...
		try {
			...
			for(PubblicationBean topics: prova) {
				if(topics.getData().equals(oggi.format(sdf)) && topics.getAutore().equals(bean.getAutore())) {
					output="trovato";
				}
			}
	...
	void testInsertReviewSuccess() {
		...
		try {
			...
			for(PubblicationBean topics: prova) {
				if(topics.getData().equals(oggi.format(sdf)) && topics.getAutore().equals(review.getAutore())) {
					output="trovato";
				}
			}
